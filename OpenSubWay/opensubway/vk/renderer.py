...
class Renderer:
    ...
    # ---------------------------------------------------------------- draw
    def draw(self, camera, items, hud_lines=None, buttons=None, overlay=None):
        ...
        self._upload_hud(hud_lines, buttons, overlay)
    ...
    def _upload_hud(self, hud_lines, buttons=None, overlay=None):
        ...
        data, count = self.hud_builder.build_frame(
            ...
            self.swap.extent.height, overlay=overlay,
        )
